...
- (void)initializeNotification{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(sendMsgToJs:) name:@"JpushNotification" object:nil];
...
- (void)sendMsgToJs:(NSNotification *)notifity{
    NSDictionary *userInfo = notifity.userInfo;
    [self jpushFireDocumentEvent:userInfo[@"event"] jsString:userInfo[@"json"]];
}
