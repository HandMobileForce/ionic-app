...
-(void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"JpushNotification" object:nil userInfo:@{@"event":JPushDocumentEvent_ReceiveNotification,@"json":[userInfo toJsonString]}];
}
...
-(void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo fetchCompletionHandler:(void (^)(UIBackgroundFetchResult))completionHandler{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"JpushNotification" object:nil userInfo:@{@"event":eventName,@"json":[userInfo toJsonString]}];
...
-(void)jpushNotificationCenter:(UNUserNotificationCenter *)center didReceiveNotificationResponse:(UNNotificationResponse *)response withCompletionHandler:(void (^)())completionHandler{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"JpushNotification" object:nil userInfo:@{@"event":JPushDocumentEvent_OpenNotification,@"json":[userInfo toJsonString]}];
    completionHandler();
}
